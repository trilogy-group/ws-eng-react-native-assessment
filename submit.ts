...
const ASSESSMENT_TYPE = 'cross-platform-mobile';
const ASSESSMENT_VERSION = 'v6';
...
const REPO_GIT_URL = 'https://github.com/trilogy-group/ws-eng-react-native-assessment.git';

async function createGitDiff(): Promise<string> {
    execCommand('git add --all');
    execCommand(`git commit --allow-empty -am "chore(mobile): Generates patch."`);
